...
<img src="https://skillicons.dev/icons?i=nextjs,react,ts,js,nodejs,express,python,java,c,c++,postgres,supabase,docker,tailwind,git,github,linux,vscode,vercel,cloudflare,npm,postman,figma,bash&perline=8"/>
</div>
